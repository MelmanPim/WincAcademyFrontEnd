...
const twoHundredPounds = superheroes.filter(person => {
    return person.weight == 200;
});

const twoHundredPoundsNames = twoHundredPounds.map(person => {
    return person.name;
});

console.log(twoHundredPounds);
console.log(twoHundredPoundsNames);


const firstAppeared = superheroes.map(person => {
    return person.first_appearance;
});
console.log(firstAppeared);
...
const heroesWeightNumberDC = DCComics.map(person => {
    return parseInt(person.weight);
});

const heroesWeightNumberMarvel = MarvelComics.map(person => {
    if (person.weight !== "unknown") {
        return parseInt(person.weight, 10);
    } else {
        return 0;
    }
});
...
console.log(bigSum(heroesWeightNumberDC))
console.log(bigSum(heroesWeightNumberMarvel))



const weight = superheroes.map(person => {
    if (person.weight !== "unknown") {
        return parseInt(person.weight, 10);
    } else {
        return 0;
...
console.log(Math.max(heroesWeightNumberDC));
